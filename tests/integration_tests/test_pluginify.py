...
# Base test(s) to ensure basic plugin repo functionality.
base_integ_test_calls = []

# Exhaustive test(s) of all remaining functionality in this repo (excluding base+lint).
